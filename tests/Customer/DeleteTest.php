...
class Customer_DeleteTest extends Mage_Selenium_TestCase
{
     ...
     * @test
     */
//####Got this message when run the test. ####
//This need to investigate when got a time to do so. 
//1) Customer_DeleteTest::throughMassAction
//PHPUnit_Framework_Exception: Response from Selenium RC server for getValue(//table[@class='data']//tr[td[normalize-space(text())='sgzsm_test_admin_1@domain.com']][td[normalize-space(text())='General']][td[normalize-space(text())='Main Website']]//input[contains(@class,'checkbox') or contains(@class,'radio')][not(@disabled)]).
//ERROR: Element //table[@class='data']//tr[td[normalize-space(text())='sgzsm_test_admin_1@domain.com']][td[normalize-space(text())='General']][td[normalize-space(text())='Main Website']]//input[contains(@class,'checkbox') or contains(@class,'radio')][not(@disabled)] not found.
